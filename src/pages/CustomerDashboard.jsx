...
import { ShoppingCart, Heart, Star, Eye, ExternalLink, Loader2, Video } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <p className="text-sm text-muted-foreground mt-1">Your purchases, favorites, reviews, and demo requests.</p>
      </motion.div>
